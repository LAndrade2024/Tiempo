...
<div>
  ...
  <modal v-model="mostrar" @input="cambioModal($event)" title="Plan nutrición" :backdrop="false">
    ...
    <div class="row">
      <div class="form-group col-sm-4">
        ...
        <v-select :options="options.comidas" v-model="formData.comida_id" :search="true"></v-select>
      </div>
      <div class="form-group col-sm-4">
        <label>Tipo</label><br/>
        <v-select :options="options.comida_tipos" v-model="formData.comida_tipo_id" :search="true"></v-select>
      </div>
      <div class="form-group col-sm-4">
        <label>Lugar</label><br/>
        <v-select :options="options.comida_lugar" v-model="formData.comida_lugar_id" ></v-select>
      </div>
...
const controller = 'nutricion_paciente';
