<template>
<div>
  <input type="file" name="fileUpload" style="display: inline-block" @change="onFileChange"> <button @click.prevent="upload()" class="btn btn-primary"><i class="fa fa-upload"></i> Importar</button>
</div>
</template>
